...
extern "C" void app_main(void) {
    // Create tasks with proper C++ wrapper
    xTaskCreate(sensor_task, "sensor_task", 2 * 4096, nullptr, 1, nullptr);
    xTaskCreate(pixel_task, "pixel_task", 2 * 4096, nullptr, 3, nullptr);
    xTaskCreate(motion_task, "motion_task", 1 * 4096, nullptr, 1, nullptr);
    xTaskCreate(mixer_task, "mixer_task", 1 * 4096, nullptr, 1, nullptr);
